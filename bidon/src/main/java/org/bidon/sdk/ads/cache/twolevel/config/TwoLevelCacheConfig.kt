...
internal data class TwoLevelCacheConfig(
    val mainCacheSize: Int, // default 10, range 1-10
    val fallbackCacheSize: Int, // default 10, range 1-10
        ...
        fun fromExtras(adType: AdType): TwoLevelCacheConfig {
            return try {
                ...
                TwoLevelCacheConfig(
                    ...
                    fallbackCacheSize = s.optInt("fallback_cache_size", DEFAULT.fallbackCacheSize).coerceIn(1, 10),
